...
(function() {
  var AUTHORIXZE_URL, debuglog, domainName, httpUtil, redis, weixinUtil, wxt, _loadAccessToken, _loadUserInfo, _redirectIndex, _sendError;
  ...
  _redirectIndex = function(res, userinfo) {
    var timestamp, userinfoStr;
    timestamp = httpUtil.generateTimestamp();
    userinfo.timestamp = timestamp;
    userinfoStr = httpUtil.xxteaEncryptObj(userinfo);
    return res.redirect("/index?timestamp=" + timestamp + "&u=" + userinfoStr);
  };
